...
public class layoutOp3Args implements NavArgs {
  private final HashMap arguments = new HashMap();

  private layoutOp3Args() {
  }

  @SuppressWarnings("unchecked")
  private layoutOp3Args(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static layoutOp3Args fromBundle(@NonNull Bundle bundle) {
    layoutOp3Args __result = new layoutOp3Args();
    bundle.setClassLoader(layoutOp3Args.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static layoutOp3Args fromSavedStateHandle(@NonNull SavedStateHandle savedStateHandle) {
    layoutOp3Args __result = new layoutOp3Args();
  ...
  public boolean equals(Object object) {
    ...
    layoutOp3Args that = (layoutOp3Args) object;
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull layoutOp3Args original) {
    ...
    @NonNull
    public layoutOp3Args build() {
      layoutOp3Args result = new layoutOp3Args(arguments);
      return result;
    }
