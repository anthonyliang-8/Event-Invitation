...
public class layoutOp1Args implements NavArgs {
  private final HashMap arguments = new HashMap();

  private layoutOp1Args() {
  }

  @SuppressWarnings("unchecked")
  private layoutOp1Args(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static layoutOp1Args fromBundle(@NonNull Bundle bundle) {
    layoutOp1Args __result = new layoutOp1Args();
    bundle.setClassLoader(layoutOp1Args.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static layoutOp1Args fromSavedStateHandle(@NonNull SavedStateHandle savedStateHandle) {
    layoutOp1Args __result = new layoutOp1Args();
  ...
  public boolean equals(Object object) {
    ...
    layoutOp1Args that = (layoutOp1Args) object;
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull layoutOp1Args original) {
    ...
    @NonNull
    public layoutOp1Args build() {
      layoutOp1Args result = new layoutOp1Args(arguments);
      return result;
    }
