...
public class LayoutFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private LayoutFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private LayoutFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static LayoutFragmentArgs fromBundle(@NonNull Bundle bundle) {
    LayoutFragmentArgs __result = new LayoutFragmentArgs();
    bundle.setClassLoader(LayoutFragmentArgs.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static LayoutFragmentArgs fromSavedStateHandle(
  ...
  public boolean equals(Object object) {
    ...
    LayoutFragmentArgs that = (LayoutFragmentArgs) object;
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull LayoutFragmentArgs original) {
    ...
    @NonNull
    public LayoutFragmentArgs build() {
      LayoutFragmentArgs result = new LayoutFragmentArgs(arguments);
      return result;
    }
