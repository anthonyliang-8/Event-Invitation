...
public class selectorFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private selectorFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private selectorFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static selectorFragmentArgs fromBundle(@NonNull Bundle bundle) {
    selectorFragmentArgs __result = new selectorFragmentArgs();
    bundle.setClassLoader(selectorFragmentArgs.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static selectorFragmentArgs fromSavedStateHandle(
  ...
  public boolean equals(Object object) {
    ...
    selectorFragmentArgs that = (selectorFragmentArgs) object;
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull selectorFragmentArgs original) {
    ...
    @NonNull
    public selectorFragmentArgs build() {
      selectorFragmentArgs result = new selectorFragmentArgs(arguments);
      return result;
    }
