...
public final class RecyclerviewItemBinding implements ViewBinding {
  ...
  private RecyclerviewItemBinding(@NonNull LinearLayout rootView, @NonNull TextView textView) {
  ...
  public static RecyclerviewItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RecyclerviewItemBinding((LinearLayout) rootView, textView);
    }
