...
public class layoutOp3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(pic == 1){
            binding.imageView4.setImageDrawable(getResources().getDrawable(R.drawable.summer));
        } else if (pic == 2) {
            binding.imageView4.setImageDrawable(getResources().getDrawable(R.drawable.ghost));
        } else if (pic == 3) {
            binding.imageView4.setImageDrawable(getResources().getDrawable(R.drawable.snowy));
        }
        else{
            binding.imageView4.setImageDrawable(getResources().getDrawable(R.drawable.cake));
        }
