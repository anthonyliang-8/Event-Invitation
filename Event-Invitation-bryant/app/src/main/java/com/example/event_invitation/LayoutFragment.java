...
public class LayoutFragment extends Fragment {
    ...
    //    Log.d("Debug", "even name:"+eventViewModel.eventName.getValue());
        ...
        addressView.setText(eventViewModel.addressName.getValue());
        timeView.setText(eventViewModel.year.getValue()+"-"+eventViewModel.month.getValue()+"-"+
                eventViewModel.day.getValue()+" "+eventViewModel.startHour.getValue()+":00-"+
                eventViewModel.endHour.getValue()+":00");
         */
